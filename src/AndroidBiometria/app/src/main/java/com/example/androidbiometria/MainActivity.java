 ...
 * @date 11/23/2025
 * @brief Actividad principal que gestiona el escaneo BLE, la autenticación y la interfaz de usuario.
 *
 * Esta actividad es el punto de entrada principal tras el login. Sus responsabilidades incluyen:
 * - Inicializar y gestionar el adaptador Bluetooth y el escáner BLE.
 * - Solicitar y gestionar los permisos de ubicación y Bluetooth en tiempo de ejecución.
 * - Escanear dispositivos BLE (filtrado o general) e interpretar tramas iBeacon.
 * - Mostrar la distancia estimada a un nodo mediante un radar visual.
 * - Gestionar la sesión del usuario con Firebase Authentication.
 * - Recibir notificaciones push y generar alertas locales.
 * - Integrar la lectura de códigos QR para asociar nodos.
 */
public class MainActivity extends AppCompatActivity {
     ...
     *
     * Inicializa la interfaz, verifica la sesión del usuario, configura el watchdog para la
     * detección de beacons, gestiona los permisos y configura los listeners de botones.
     *
    ...
    /**
     * @brief Inicializa el menú de opciones de la barra de herramientas.
     */
    @Override
    ...
    /**
     * @brief Maneja la selección de items en el menú de opciones.
     */
    @Override
    ...
    /**
     * @brief Abre la actividad de la intranet obteniendo un link de autologin.
     */
    ...
    /**
     * @brief Calcula la distancia estimada basándose en RSSI y TxPower.
     * @param rssi Potencia de la señal recibida.
     * @param txPower Potencia de transmisión calibrada a 1 metro.
    ...
    /**
     * @brief Muestra información detallada de un dispositivo BLE detectado en el log.
    ...
    /**
     * @brief Inicia la búsqueda de un dispositivo BTLE específico.
    ...
    /**
     * @brief Detiene el escaneo BLE activo.
     */
    ...
    /**
     * @brief Acción del botón para detener el escaneo.
    ...
    /**
     * @brief Inicializa el adaptador Bluetooth y solicita los permisos necesarios.
     */
    ...
    /**
     * @brief Maneja la respuesta del usuario a la solicitud de permisos.
     */
    @Override
    ...
    /**
     * @brief Verifica si Bluetooth y GPS están activados. Si no, solicita activación.
     */
    ...
    /**
     * @brief Muestra un diálogo solicitando activar Bluetooth y/o GPS.
     */
    ...
    /**
     * @brief Convierte un resultado de escaneo BLE en un objeto LogicaFake para procesamiento.
     * @param resultado Resultado del escaneo.
     * @return Objeto LogicaFake con los datos del beacon.
     */
    ...
    /**
     * @brief Genera una notificación local para alertar al usuario.
     * @param mensaje Texto de la alerta.
     * @param colorTexto Color asociado (informativo, no usado directamente en la UI).
     */
    ...
    /**
     * @brief Maneja el resultado de actividades iniciadas con startActivityForResult.
     * Captura el resultado del escaneo de código QR.
     */
    @Override
    ...
    /**
     * @brief Inicia la búsqueda del dispositivo tras leer el QR.
     */
    ...
    /**
     * @brief Muestra la UI dinámica para confirmar el nodo detectado y empezar a buscarlo.
     */
    ...
    /**
     * @brief Obtiene un enlace de autologin desde el servidor REST.
    ...
    /**
     * @brief Método llamado cuando la actividad vuelve a primer plano.
     */
    @Override
    ...
    /**
     * @brief Cierra la sesión del usuario y redirige al login.
     */
